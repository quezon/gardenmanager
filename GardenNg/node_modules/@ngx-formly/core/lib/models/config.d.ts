...
export declare type FieldValidatorFn = (c: AbstractControl, field: FormlyFieldConfig) => ValidationErrors | null;
...
export declare type ManipulatorWrapper = (f: FormlyFieldConfig) => string;
