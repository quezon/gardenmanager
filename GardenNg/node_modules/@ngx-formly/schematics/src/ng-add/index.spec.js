...
describe('ng-add-schematic', () => {
    ...
    it('should not add a theme by default to package.json', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield schematicRunner
            .runSchematicAsync('ng-add', {}, appTree)
            .toPromise();
        const packageJson = JSON.parse(test_1.getFileContent(tree, '/package.json'));
    ...
    it('should skip package.json update', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should add to root app module', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield schematicRunner
            .runSchematicAsync('ng-add', {}, appTree)
            .toPromise();
    ...
    it('should add UI theme to package.json', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield schematicRunner
    ...
    it('should add UI theme to root app module', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield schematicRunner
            .runSchematicAsync('ng-add', { uiTheme: 'bootstrap' }, appTree)
            .toPromise();
        const content = tree.readContent(`${projectPath}/src/app/app.module.ts`);
    ...
    it('should add to any module', () => __awaiter(this, void 0, void 0, function* () {
