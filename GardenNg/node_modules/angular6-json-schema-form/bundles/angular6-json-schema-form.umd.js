(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es/cloneDeep'), require('ajv'), require('ajv/lib/refs/json-schema-draft-06.json'), require('lodash-es/filter'), require('lodash-es/map'), require('@angular/forms'), require('rxjs'), require('@angular/core'), require('lodash-es/isEqual'), require('rxjs/operators'), require('lodash-es/uniqueId'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/material/core'), require('@angular/material/form-field'), require('@angular/flex-layout'), require('@angular/flex-layout/core'), require('@angular/material/autocomplete'), require('@angular/material/button'), require('@angular/material/button-toggle'), require('@angular/material/card'), require('@angular/material/checkbox'), require('@angular/material/chips'), require('@angular/material/datepicker'), require('@angular/material/expansion'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/radio'), require('@angular/material/select'), require('@angular/material/slide-toggle'), require('@angular/material/slider'), require('@angular/material/stepper'), require('@angular/material/tabs'), require('@angular/material/tooltip')) :
    typeof define === 'function' && define.amd ? define('angular6-json-schema-form', ['exports', 'lodash-es/cloneDeep', 'ajv', 'ajv/lib/refs/json-schema-draft-06.json', 'lodash-es/filter', 'lodash-es/map', '@angular/forms', 'rxjs', '@angular/core', 'lodash-es/isEqual', 'rxjs/operators', 'lodash-es/uniqueId', '@angular/platform-browser', '@angular/common', '@angular/material/core', '@angular/material/form-field', '@angular/flex-layout', '@angular/flex-layout/core', '@angular/material/autocomplete', '@angular/material/button', '@angular/material/button-toggle', '@angular/material/card', '@angular/material/checkbox', '@angular/material/chips', '@angular/material/datepicker', '@angular/material/expansion', '@angular/material/icon', '@angular/material/input', '@angular/material/radio', '@angular/material/select', '@angular/material/slide-toggle', '@angular/material/slider', '@angular/material/stepper', '@angular/material/tabs', '@angular/material/tooltip'], factory) :
    (global = global || self, factory(global['angular6-json-schema-form'] = {}, global['lodash-es'], global.ajv, global.jsonDraft6, global['lodash-es'], global['lodash-es'], global.ng.forms, global.rxjs, global.ng.core, global['lodash-es'], global.rxjs.operators, global['lodash-es'], global.ng.platformBrowser, global.ng.common, global.ng.material.core, global.ng.material['form-field'], global.ng['flex-layout'], global.ng['flex-layout'].core, global.ng.material.autocomplete, global.ng.material.button, global.ng.material['button-toggle'], global.ng.material.card, global.ng.material.checkbox, global.ng.material.chips, global.ng.material.datepicker, global.ng.material.expansion, global.ng.material.icon, global.ng.material.input, global.ng.material.radio, global.ng.material.select, global.ng.material['slide-toggle'], global.ng.material.slider, global.ng.material.stepper, global.ng.material.tabs, global.ng.material.tooltip));
}(this, function (exports, cloneDeep, Ajv, jsonDraft6, filter, map$1, forms, rxjs, core, isEqual$1, operators, uniqueId, platformBrowser, common, core$1, formField, flexLayout, core$2, autocomplete, button, buttonToggle, card, checkbox, chips, datepicker, expansion, icon, input, radio, select, slideToggle, slider, stepper, tabs, tooltip) { 'use strict';
                            ...
                            case 'enum':
                                ...
                                if (isArray(combinedValue) && isArray(schemaValue)) {
                                    combinedSchema[key] = combinedValue.filter(function (item1) {
                                        return schemaValue.findIndex(function (item2) { return isEqual$1(item1, item2); }) > -1;
                                    });
    ...
    */
    function buildFormGroup(template) {
        ...
        if (hasOwn(template, 'controlType')) {
            switch (template.controlType) {
                ...
                case 'FormArray':
                    return new forms.FormArray(filter(map$1(template.controls, function (controls) { return buildFormGroup(controls); })), validatorFn);
                case 'FormControl':
    ...
    var SelectFrameworkComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('widgetContainer', {
            ...
            if (!this.formInitialized || !this.formValuesInput ||
                ...
                if (changedInput.length === 1 && changedInput[0] === 'form' &&
                    ...
                    changedInput = Object.keys(this.previousInputs.form || {})
                        .filter(function (key) { return !isEqual$1(_this.previousInputs.form[key], _this.form[key]); })
    ...
    var MaterialDatepickerComponent = /** @class */ (function () {
        ...
        MaterialDatepickerComponent = __decorate([
            ...
            __param(0, core.Inject(formField.MAT_FORM_FIELD_DEFAULT_OPTIONS)), __param(0, core.Optional()),
            __param(1, core.Inject(core$1.MAT_LABEL_GLOBAL_OPTIONS)), __param(1, core.Optional()),
    ...
    var ANGULAR_MATERIAL_MODULES = [
        ...
        formField.MatFormFieldModule, icon.MatIconModule, input.MatInputModule, core$1.MatNativeDateModule,
