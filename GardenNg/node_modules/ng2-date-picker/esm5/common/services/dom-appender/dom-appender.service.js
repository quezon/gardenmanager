...
var DomHelper = /** @class */ (function () {
    ...
    var DomHelper_1;
    DomHelper.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function DomHelper_Factory() { return new DomHelper(); }, token: DomHelper, providedIn: "root" });
    DomHelper = DomHelper_1 = tslib_1.__decorate([
        Injectable({
            providedIn: 'root'
        })
    ], DomHelper);
